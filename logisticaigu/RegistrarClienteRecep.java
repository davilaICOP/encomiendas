...
public class RegistrarClienteRecep extends javax.swing.JFrame {
     ...
     */
    public RegistrarClienteRecep(Paquete paqueteTemporal) {
        initComponents();
...
private boolean camposLlenos() {
    ...
    if (camposLlenos()) {
        ...
        if (confirmacion == JOptionPane.YES_OPTION) {
            ...
            BuscarClienteReceptor buscarClienteReceptor = new BuscarClienteReceptor(paqueteTemporal);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
     BuscarClienteReceptor atras = new BuscarClienteReceptor(paqueteTemporal);
